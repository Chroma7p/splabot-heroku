...
import discord
from weapon import get_weapon_info,extract_weapon_types,filter_weapons
import random
...
class WeaponCog(commands.Cog):
    def __init__(self, bot):
        ...
        self.weapon_types, self.sub_types, self.special_types = extract_weapon_types(self.weapons)
